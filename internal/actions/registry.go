...
var Registry = map[string]Def{
	...
	"update.rollout":           {ID: "update.rollout", Scope: ScopeAgents, Risk: "disruptive", RequiresCapability: "binary_update", DurableOperation: true, IdempotencyRequired: true, RecentAuthenticationRequired: true, AuthoritativeCompletion: "build_digest_session_committed_current_exchange"},
	...
	"update.resume":            {ID: "update.resume", Scope: ScopeServerJob, Risk: "disruptive", DurableOperation: true, IdempotencyRequired: true, RecentAuthenticationRequired: true, AuthoritativeCompletion: "revalidated_rollout_authorization"},
