...
const density=ref(tvDensity(readPreference('monik:tv-font','14'))),notice=ref('');
...
function size(value:string){density.value=tvDensity(value);notice.value=savePreference('monik:tv-font',density.value)?'':'Плотность изменена, но браузер не сохранил выбор.';}
