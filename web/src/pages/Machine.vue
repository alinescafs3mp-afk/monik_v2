...
<template>
 <div>
  ...
  <template v-if="detail">
   ...
   <section v-if="tab==='services'||tab==='summary'" id="services" class="panel"><h3>Сервисы: текущее состояние</h3><ServiceList :services="detail.services || []" configure-in-place @configure="configureService"/></section>
